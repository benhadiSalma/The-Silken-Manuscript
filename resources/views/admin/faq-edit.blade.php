...
<head>
    <meta charset="UTF-8">
    <title>Edit FAQ - The Silken Manuscript</title>
...
<body>
    <main class="card">
        <h1>Edit FAQ Item</h1>
        <p class="subtitle">Revise this question and answer before returning it to the archive.</p>
        ...
        <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
            ...
            <div>
                ...
                <input id="category" type="text" name="category" value="{{ old('category', $faq->category) }}" required>
                @error('category')
            ...
            <div>
                ...
                <input id="question" type="text" name="question" value="{{ old('question', $faq->question) }}" required>
                @error('question')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
