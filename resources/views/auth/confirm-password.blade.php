...
<head>
    ...
    <title>Confirm Password - The Silken Manuscript</title>
...
<body>
    <div class="confirm-container">
        ...
        <p class="subtitle">
            This is a protected area of the archive. Confirm your password before continuing.
        </p>
        ...
        <div class="bottom-link">
            <a href="{{ route('index') }}">Return to the archive.</a>
        </div>
    </div>
</body>
</html>